...
public class Anjuke {
	public static void main(String[] args) {
		...
		// List<WebElement> ff=
		// Driver.findElements(By.xpath(".//*[@id='calleft']/div[1]/span[1]"));
		 ...
		 * 
		 * List<WebElement> year =Driver.findElements(By.xpath(
		 * "//*[@style='height:32px;line-height:32px;']")); year.get(10);
		 * 
		 * Select Firet_year = new Select(Driver.findElement(By.id("yearOne")));
		 * Firet_year.selectByIndex(0);
		 * 
		 * Select Firet_month = new
		 * Select(Driver.findElement(By.id("monthOne")));
